...
// configuration step. It creates a namespace called `jt_cmake`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", jt_cmake::cmake::project_name, jt_cmake::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", jt_cmake::cmake::project_version);
      return EXIT_SUCCESS;
    }
